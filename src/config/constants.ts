...
export const WITHDRAWAL_FEES = {
  DEFAULT_RELAY_FEE_BPS: BigInt(1500), // 15% fee in basis points
} as const;
...
export const CONTRACTS = {
  ...
  PAYMASTER: "0x018C638b4e7Ca920869E3D8248f334Cd688ed204",
  CROSSCHAIN_WITHDRAWAL_PAYMASTER: "0x5e6EF58308f205B921592c389b934Cfc0B949e0D" as `0x${string}`,
  
  EXTENTED_INPUT_SETTLER_ESCROW_ADDRESS: "0xDfF28DEEBD9Fb5449552b18B9954056249D612d5" as `0x${string}`,
  EXTENTED_OUTPUT_SETTLER_ESCROW_ADDRESS: "0x0c5944d048f72574E6a83929c3286fEB61C37bf0" as `0x${string}`,
  CROSSCHAIN_INPUT_ORACLE: "0xB8244C64F4Af0F9509015Ea84F814aBaD326FE75" as `0x${string}`,
  CROSSCHAIN_OUTPUT_ORACLE: "0x9190c0a95D5Ff15fc5051F45436cc77B0a9a4843" as `0x${string}`,
  ...
  PRIVACY_POOL_ENTRYPOINT: "0x143e3dE7651a7BBa2d9FB25C3Ff6CdE41e4aCA42",
  ETH_PRIVACY_POOL: "0x48F5B3bba18dBF2A445c169023402F19fEf5ED21",
