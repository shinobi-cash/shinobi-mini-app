...
export const WalletGate = ({
      ...
      return (
        <div className="h-full flex flex-col items-center justify-center px-4">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-6 max-w-sm w-full">
            ...
            <p className="text-xs text-app-secondary mt-1">via {connector?.name}</p>
          </div>
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-4">
      ...
      <h2 className="text-xl font-bold mb-2 text-center text-app-primary">{title}</h2>

      <p className="text-base mb-8 text-center text-app-secondary max-w-sm">{description}</p>
